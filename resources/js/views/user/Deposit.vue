...
const handleSubmit = async () => {
    ...
    success.value = '';
    try {
        const result = await transactionStore.deposit(parseFloat(form.amount), form.description);
        success.value = `Successfully deposited ₱${formatCurrency(form.amount)}. Reference: ${result.transaction.reference_number}`;
        form.amount = '';
        form.description = '';
    } catch (e) {
